                ...
                <div className="mx-auto w-full max-w-[550px] bg-white">
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div className="mb-5">
                            ...
                            <input   {...register("name", { required: true })} type="text" name="name" placeholder='Post Title'
                        ...
                        <div className="mb-5">
                            ...
                            <input type="text" name="location"  {...register("location", { required: true })} placeholder="Enter Location"
                                className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                        </div>
                        <div className="mb-5">
                            <label for="phone" className="mb-3 block text-base font-medium text-[#07074D]">
                            ...
                            <input type="number" name="location"  {...register("need", { required: true })} placeholder=" No. of volunteers needed"
                                className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                        </div>
                        <div className="mb-5">
                            ...
                            <input   {...register("photo", { required: true })} type="url" name="photo" id="photo" placeholder="Enter Photo Url"
                                className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                        </div>
                            ...
                            <div className="w-full px-3 sm:w-1/2">
                                <div className="mb-5">
                                    ...
                                    <select   {...register("Category", { required: true })} className="select select-bordered w-full max-w-xs">
                                        <option disabled defaultValue>Select Subcategory</option>
